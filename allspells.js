...
bane = {
  ...
  description:"Up to three creatures you can see must make Charisma saving throws. If a target fails, whenever they make an attack roll or saving throw before the spell ends, they must roll a d4 and subtract the number rolled.\n\
...
speak_with_animals = {
  ...
  components:"V S",
  description:"Although limited by the intelligence of the beast, you can understand and speak with beasts. You learn about the beast's experiences over the last day, as well as local places and creatures.\n\
...
detect_evil_and_good = {
  ...
  casting_time:"1 action",
  components:"V S",
  description:"You sense the location of an aberration, celestial, elemental, fey, fiend, or undead if it is within 30 feet of you. If there is a place or object that has been magically consecrated or desecrated within 30 feet, you are also able to locate it.\n\
...
detect_poison_and_disease = {
  ...
  description:"If they exist or appear within 30 feet, you sense the presence of poisons, poisonous creatures, and diseases. Their location and type also become known to you.\n\
...
produce_flame = {
  ...
  casting_time:"1 action",
  components:"V S",
  description:"A flame appears in your hand, harming neither you or your equipment. It sheds bright light in a 10-foot radius and dim light for an additional 10 feet. The spell ends if you dismiss it as an action or if you cast it again.\n\
...
entangle = {
  ...
  casting_time:"1 action",
  components:"V S",
  description:"Plants that grab and entwine fill a 20-foot square with a point of origin that you choose. The area becomes difficult terrain. When the spell ends, the plants wilt away.\n\
...
fog_cloud = {
  ...
  casting_time:"1 action",
  components:"V S",
  description:"A 20-foot-radius sphere of fog appears within range of you until a wind of at least 10 miles per hour blows it away, or until the spell ends. The fog is centered on a point you choose, spreading around corners and heavily obscuring the area it fills.\n\
...
chill_touch = {
  ...
  casting_time:"1 action",
  components:"V S",
  description:"Make a ranged spell attack. On hit, the target takes 1d8 necrotic damage and can't regain hit points until the start of your next turn.\n\
